...
def _relative_minutes(
    release_time: datetime,
    minutes: int | None,
) -> int | None:
    """Return remaining minutes within the valid RV time window."""
...
class Product(ABC):
    ...
    def history_value(self):
        """Return value for persistent history."""
        ...
        for ts in release_candidates:
            ...
            try:
                ...
                self.data = {
                    ...
                    "precipitation_now": new_data[0],
                    "precipitation_5": new_data[1],
...
class RadolanRW(RadolanProduct):
    ...
    @property
    def history_value(self):
        """Return RW value for persistent history."""
